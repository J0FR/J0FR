...
def ejecutar_contar_sitios_especiales( s1: dict, s2: dict, s3: dict,
    ...
    cuello_de_botella = diccionario_sitios_especiales["cuello_de_botella"]
    print(f"Hay {zona_recreacional} zonas recreacionales, {cuello_de_botella} cuellos de botella y {cuello_de_botella} zonas escolares en todos los sectores de la vía.")
    #TODO: Completar
